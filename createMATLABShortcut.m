...
outputFilename = ['C:\Users\Guannan\Desktop\MATLAB_R' version('-release') '_JVMstarter.app'];
...
copyfile(fullfile(matlabroot, 'bin','win64', 'matlab.ico'), fullfile(outputFilename, 'bin','win64', 'matlab.ico'))
system(['defaults write ' fullfile(outputFilename, 'bin', 'Info') ' CFBundleIconFile MATLAB']);
